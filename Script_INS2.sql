...
--Consulta F--
	...
	FROM  INS1.AdventureWorks2019.Sales.SalesOrderHeader soh inner join INS3.AdventureWorks2019.Purchasing.ShipMethod metodo
...
--Consulta G--
	...
	set @EmailNew = N'ari0@adventure-works.com'
	set @ClienteID = 3

	UPDATE INS3.AdventureWorks2019.Person.EmailAddress set EmailAddress = @EmailNew WHERE BusinessEntityID = @ClienteID

	SELECT C.CustomerID as ID_Cliente, Email.EmailAddress as Email
	FROM INS1.AdventureWorks2019.sales.Customer c
	inner join INS3.AdventureWorks2019.Person.EmailAddress Email
	on Email.BusinessEntityID = C.CustomerID 
	where Email.EmailAddress = @EmailNew

	select * from INS3.AdventureWorks2019.Person.EmailAddress
...
--Consulta H--
    ...
    AS pedidos ORDER BY TerritoryID, Total_Pedidos DESC) AS t1  INNER JOIN INS3.AdventureWorks2019.Person.Person as P ON t1.SalesPersonID = P.BusinessEntityID
   ...
   SELECT TerritoryID,SalesPersonID, P.FirstName, P.LastName, Total_Pedidos FROM
    ...
    AS pedidos ORDER BY TerritoryID, Total_Pedidos DESC) AS t2  INNER JOIN INS3.AdventureWorks2019.Person.Person as P ON t2.SalesPersonID = P.BusinessEntityID
   ...
   SELECT TerritoryID,SalesPersonID, P.FirstName, P.LastName, Total_Pedidos FROM
    ...
    AS pedidos ORDER BY TerritoryID, Total_Pedidos DESC) AS t3  INNER JOIN INS3.AdventureWorks2019.Person.Person as P ON t3.SalesPersonID = P.BusinessEntityID
   ...
   SELECT TerritoryID,SalesPersonID, P.FirstName, P.LastName, Total_Pedidos FROM
    ...
    AS pedidos ORDER BY TerritoryID, Total_Pedidos DESC) AS t4  INNER JOIN INS3.AdventureWorks2019.Person.Person as P ON t4.SalesPersonID = P.BusinessEntityID
   ...
   SELECT TerritoryID,SalesPersonID, P.FirstName, P.LastName, Total_Pedidos FROM
    ...
    AS pedidos ORDER BY TerritoryID, Total_Pedidos DESC) AS t5  INNER JOIN INS3.AdventureWorks2019.Person.Person as P ON t5.SalesPersonID = P.BusinessEntityID
   ...
   SELECT TerritoryID,SalesPersonID, P.FirstName, P.LastName, Total_Pedidos FROM
    ...
    AS pedidos ORDER BY TerritoryID, Total_Pedidos DESC) AS t6  INNER JOIN INS3.AdventureWorks2019.Person.Person as P ON t6.SalesPersonID = P.BusinessEntityID
   ...
   SELECT TerritoryID,SalesPersonID, P.FirstName, P.LastName, Total_Pedidos FROM
    ...
    AS pedidos ORDER BY TerritoryID, Total_Pedidos DESC) AS t7  INNER JOIN INS3.AdventureWorks2019.Person.Person as P ON t7.SalesPersonID = P.BusinessEntityID
   ...
   SELECT TerritoryID,SalesPersonID, P.FirstName, P.LastName, Total_Pedidos FROM
    ...
    AS pedidos ORDER BY TerritoryID, Total_Pedidos DESC) AS t8  INNER JOIN INS3.AdventureWorks2019.Person.Person as P ON t8.SalesPersonID = P.BusinessEntityID
   ...
   SELECT TerritoryID,SalesPersonID, P.FirstName, P.LastName, Total_Pedidos FROM
    ...
    AS pedidos ORDER BY TerritoryID, Total_Pedidos DESC) AS t9  INNER JOIN INS3.AdventureWorks2019.Person.Person as P ON t9.SalesPersonID = P.BusinessEntityID
   ...
   SELECT TerritoryID,SalesPersonID, P.FirstName, P.LastName, Total_Pedidos FROM
    ...
    AS pedidos ORDER BY TerritoryID, Total_Pedidos DESC) AS t10  INNER JOIN INS3.AdventureWorks2019.Person.Person as P ON t10.SalesPersonID = P.BusinessEntityID
