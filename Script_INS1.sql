...
--Consulta F--
	...
	FROM  AdventureWorks2019.Sales.SalesOrderHeader soh inner join INS3.AdventureWorks2019.Purchasing.ShipMethod metodo
...
--Consulta G--
	...
	set @EmailNew = N'dani0@adventure-works.com'
	set @ClienteID = 3
